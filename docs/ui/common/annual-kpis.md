...
2026-09-10: 진행 중 프로젝트·완료 프로젝트 수를 접힌 영역에서 상단 기본 영역으로 옮기고 [프로젝트 완료율](../overview/cards/project-completion-rate.md)을 추가했습니다. 완료율은 완료 / 전체 프로젝트로 계산하며 보류도 분모에 포함합니다. 기존 하위 업무 완료율과 구분합니다.

2026-09-09: 통합 현황과 프로젝트 관리의 연도 버튼을 ‘기준 연도’ 드롭다운으로 바꾸고 선택 연도만 표시한다. 삭제 표시된 프로젝트는 프로젝트·사업 집계에서 제외하되 농가·구독·입금 원본은 보존한다. [개선 내용](../projects/management-update.md).
