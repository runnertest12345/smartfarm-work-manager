...
function SheetContent({
  ...
  displayMode?: 'panel' | 'workspace' | 'dialog';
  showOverlay?: boolean;
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          'bg-popover text-popover-foreground fixed z-50 flex flex-col gap-4 bg-clip-padding text-sm',
          displayMode === 'dialog'
            ? 'top-1/2 left-1/2 h-[min(92dvh,1100px)] w-[calc(100%-2rem)] max-w-[1200px] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-2xl border shadow-2xl outline-none'
            : displayMode === 'workspace'
            ? 'top-[72px] right-0 bottom-0 left-0 lg:left-[252px]'
